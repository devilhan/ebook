...
class TagModel(models.Model):
    tag_id = models.ForeignKey(Channel, verbose_name="小说的频道", on_delete=models.CASCADE)
...
class NovelModel(models.Model):
    ...
    novel_image = models.ImageField(upload_to="novel/%Y/%m", null=True, blank=True, max_length=100,
                                    verbose_name="小说的封面图")
    novel_user = models.ForeignKey(UserProFile, null=True, blank=True, verbose_name="小说的作者", on_delete=models.CASCADE)
    ...
    novel_tag = models.ForeignKey(TagModel, null=True, blank=True, verbose_name="小说的类别", on_delete=models.CASCADE)
...
class IndexNovel(models.Model):
    ...
    novel = models.ForeignKey(NovelModel, verbose_name="推荐的小说", on_delete=models.CASCADE)
    novel_image = models.ImageField(upload_to="tuiimg/%Y/%m", null=True, blank=True, max_length=100,
                                    verbose_name="推荐小说的封面图")
